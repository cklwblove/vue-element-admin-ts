  ...
  <div>
    <sticky class-name="sub-navbar">
      ...
      <div class="time-container">
        <el-date-picker v-model="time" :picker-options="pickerOptions" type="datetime" format="yyyy-MM-dd HH:mm:ss"
...
<script lang="ts">
  ...
  export default class StickyView extends Vue {
    time: string = '';
    url: string = '';
    platforms: string[] = ['a-platform'];
    platformsOptions: any[] = [
