<template>
  <div class="components-container">
    ...
    <code>&lt;count-to :start-val=&#x27;{{ _startVal }}&#x27; :end-val=&#x27;{{ _endVal }}&#x27; :duration=&#x27;{{
      _duration }}&#x27;
...
<script lang="ts">
  ...
  export default class CountToView extends Vue {
    setStartVal: number = 0;
    setEndVal: number = 2017;
    setDuration: number = 4000;
    setDecimals: number = 0;
    setSeparator: string = ',';
    setSuffix: string = ' rmb';
    setPrefix: string = '¥ ';
    $refs!: {
      example: any;
    };
